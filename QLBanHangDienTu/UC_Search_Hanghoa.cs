...
{
    public partial class UC_Search_Hanghoa : UserControl
    {
        public UC_Search_Hanghoa()
        {
            InitializeComponent();
        }

        private void notChangeText(object sender, EventArgs e)
        {
        ...
        private void btnTimkiem_Click(object sender, EventArgs e)
       {
        ...
        private void UC_Search_Hanghoa_Load(object sender, EventArgs e)
        {
            showData();
        }
