...
{
    public partial class UC_Search_Hoadonnhap : UserControl
    {
        public UC_Search_Hoadonnhap()
        {
            InitializeComponent();
        }

        private void grTime_Enter(object sender, EventArgs e)
        {
        ...
        private void UC_Search_Hoadonnhap_Load(object sender, EventArgs e)
        {
            grTime.Visible = false;
            showHDN();
        }
